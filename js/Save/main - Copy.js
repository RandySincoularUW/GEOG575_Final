...
//* Location of Home for Easy Button
var home = {
  lat: 43.076,
  lng: -89.199,
  zoom: 13
...
//* 23-Apr-17 Add Geocoder to Map
// L.control.geocoder('mapzen-Cr8v2MA').addTo(map);
...
var parcelLayer2 = $.getJSON(cg_parcels, function(hoodData) {
	...
	onEachFeature: function(feature,layer) {
		layer.bindPopup("<b>Property Owner: </b>" + feature.properties.Owner + "<br>" + "<b>Billing Address: </b>" + feature.properties.BillingStr + "</br>" + feature.properties.BillingCty)
	}
}).addTo(map);
